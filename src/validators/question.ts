...
export const createQuestionSchema = z.object({
  ...
  (data) => SOLUTION_OPTIONAL_CATEGORIES.includes(data.category) || (data.solution && data.solution.trim().length > 0),
  { message: "Solution is required for this category", path: ["solution"] },
);
