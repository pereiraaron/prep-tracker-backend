    ...
    "/api/questions": {
      get: {
        ...
        parameters: [
          ...
          { name: "topic", in: "query", schema: { type: "string" as const }, description: "Filter by topic (matches any element in topics array)" },
        ...
        parameters: [
          {
            ...
            required: true,
            schema: { type: "string" as const },
            description: "Search query (matches title, topics, tags, companyTags via text index; falls back to regex substring matching)",
          },
          { name: "status", in: "query", schema: { $ref: "#/components/schemas/QuestionStatus" } },
          { name: "difficulty", in: "query", schema: { $ref: "#/components/schemas/Difficulty" } },
        ],
